...
export const glossaryEntries: GlossaryEntry[] = [
  ...
  },
  {
    ...
    content:
      ...
      "是否能拿到 5K，取決於你放置標記的位置是否落在系統允許的**滿分判定範圍**內。這個可容許的最大誤差，會隨著地圖尺度與題目類型而有所不同。\n\n" +
  ...
  },
  {
    title: "Vibe (氛圍)",
    content:
      "當你對一個特定的區域、國家非常熟悉的時候，不需要具體的線索就靠畫面的氛圍 (vibe) 進行猜測。\n\n"
  },
  {
    title: "Urban / Rural (城市 / 鄉村)",
    content:
      "就是字面上的意思，但即使史同一個國家，在市區與鄉村能使用的線索與策略不同，所以還是需要區分。\n\n"
  },
  {
  ...
  },
  {
    ...
    content:
      ...
      "Rainbolt 的影片與直播對 GeoGuessr 社群影響很大，也讓許多玩家開始學習與整理所謂的「meta 線索」，進一步提升整體玩家對地理與觀察力的理解。",
  }
];
