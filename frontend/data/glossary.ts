...
export const glossaryEntries: GlossaryEntry[] = [
  ...
  },
  {
    title: "50/50",
    content:
      "以目前能取得的資訊來看，兩個選項各自都有約 50% 的可能性。\n\n" +
      "這種情況通常會出現在風格或特徵高度相近的國家之間，\n\n" +
      "像是美國／加拿大、捷克／斯洛伐克、南非／澳洲。",
  },
  {
    title: "Hedge (保守猜)",
    content:
      "指的是在**不太可能是精確位置**的地方下猜，但會選在所有可能區域的大致中心點。這種猜法的目標是把**失分降到最低**，而不是為了衝高分數去做高風險的精準猜測。\n\n" +
      "所謂的 「**water hedge**」，則是指在玩家認為有可能的多塊陸地之間，直接猜在水面上的一種保守猜法。\n\n",
  },
  {
  ...
  },
  {
    title: "ELO Rating",
    content:
      "ELO Rating 是一種用來衡量玩家實力強弱的評分系統，最早用於西洋棋，現在也被廣泛應用在各種競技遊戲與對戰系統中。\n\n" +
      "ELO 的核心概念是「相對強度」：當你擊敗比自己分數高的對手時，獲得的分數會比較多；反之，輸給分數較低的對手時，扣分也會比較重。\n\n" +
      "大師牌位 (Master) 保底約為 800 rating，冠軍牌位 (Champion) 保底約為 1200 rating。\n\n" +
      "黃金以下的牌位記分板顯示的分數 **不是** ELO Rating，而是當週的積分 (Points)。",
  },
];
