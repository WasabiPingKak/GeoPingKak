[![CI](https://github.com/WasabiPingKak/GeoPingKak/actions/workflows/deploy-production.yml/badge.svg)](https://github.com/WasabiPingKak/GeoPingKak/actions/workflows/deploy-production.yml)
